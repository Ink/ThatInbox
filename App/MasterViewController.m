...
- (void) finishedAuth {
    //For the first time you're here, we add a few fake emails to your account
    [self loadAccount];
}
...
- (void) sendInkEmails {
    ...
    [[builder header] setBcc:@[[MCOAddress addressWithMailbox:@"contact@inkmobility.com"]]];
...
- (void)composeEmail:(id)sender {
    ...
    [attachment setFilename:@"Learning Facilities Report.pdf"];
     */
