...
- (void)viewDidLoad
{
    ...
    if (self.message != nil){
        //Add the menu butttons when you have a message
...
- (IBAction)replyWindow:(id)sender{
    ...
    if ([type isEqualToString: @"Forward"]){
        // The goal is to forward attachements. Since these are MCOIMAPParts (not MCOAttachments), you don't have the data yet
        // Using delayed attachments instead.
