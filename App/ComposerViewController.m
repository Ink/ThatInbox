...
- (IBAction)attachmentTapped:(id)sender
{
    ...
    /*
    //TODO: Need to make this do stuff
    AttachmentPopoverController *nc = [[AttachmentPopoverController alloc] init];
    pop = [[UIPopoverController alloc] initWithContentViewController:nc];
    [pop setPopoverContentSize:CGSizeMake(150, 30)];
    [pop configureFlatPopoverWithBackgroundColor:[UIColor silverColor] cornerRadius:3];
    [pop presentPopoverFromRect:[sender frame] inView:[sender superview] permittedArrowDirections:UIPopoverArrowDirectionAny animated:YES];
    NSLog(@"STUFF");
     */
}
